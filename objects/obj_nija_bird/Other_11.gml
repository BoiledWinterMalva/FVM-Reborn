...
var inst = instance_create_depth(x+75,y-55,depth-500,obj_takoyaki_bullet)
inst.damage = atk
inst.move_speed = 10
inst.target_enemy = target
inst.banding_card_obj = id
inst.row = grid_row
inst.sprite_index = spr_nija_bird_bullet
if shape == 1 {
	inst.sprite_index = spr_nija_bird_bullet_1
} else if shape >= 2 {
	inst.sprite_index = spr_nija_bird_bullet_2
}