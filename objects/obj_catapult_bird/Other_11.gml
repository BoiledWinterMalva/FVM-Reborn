// 用户事件1 - 发射子弹
var inst = instance_create_depth(x-10, y-125, depth-500, obj_catapultbird_bullet)
if shape == 1 {
	inst.sprite_index = spr_catapultbird_bullet_1
} else if shape >= 2 {
	inst.sprite_index = spr_catapultbird_bullet_2
}
