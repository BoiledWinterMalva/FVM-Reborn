function shop_init(){
	...
	register_goods("warm_birds",{"type":"card","cost":"30000","unlock_item_id":"warm_birds","description":"暖暖鸡：很烧，生产3朵火苗","display_name":"暖暖鸡"})
	register_goods("gugu_birds",{"type":"card","cost":"30000","unlock_item_id":"gugu_birds","description":"咕咕鸡：放在酒杯灯上，生产3朵火苗","display_name":"咕咕鸡"})
	register_goods("nija_bird",{"type":"card","cost":"50000","unlock_item_id":"nija_bird","description":"忍忍鸡：咿呀！忍者追踪飞镖3连","display_name":"忍忍鸡"})
	register_goods("silly_bird",{"type":"card","cost":"50000","unlock_item_id":"silly_bird","description":"呆呆鸡：向前后两个方向发射羽毛","display_name":"呆呆鸡"})
	register_goods("bangbang_bird",{"type":"card","cost":"50000","unlock_item_id":"bangbang_bird","description":"砰砰鸡：向前方三行发射3只愤怒小鸟","display_name":"砰砰鸡"})
	register_goods("rotating_bird",{"type":"card","cost":"70000","unlock_item_id":"rotating_bird","description":"转转鸡：5*5范围穿透攻击","display_name":"转转鸡"})
	register_goods("catapult_bird",{"type":"card","cost":"50000","unlock_item_id":"catapult_bird","description":"弹弹鸡：投掷两颗3*3范围溅射鸡蛋","display_name":"弹弹鸡"})
	register_goods("bobo_bird",{"type":"card","cost":"80000","unlock_item_id":"bobo_bird","description":"钵钵鸡：投掷麻辣串炸弹，间隔召唤小鸡冲撞整行","display_name":"钵钵鸡"})
